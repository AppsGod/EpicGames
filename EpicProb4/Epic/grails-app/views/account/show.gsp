	...
	<body>
		...
		<div id="show-account" class="content scaffold-show" role="main">
			...
			<ol class="property-list account">
				...
				<g:if test="${accountInstance?.dob}">
				<li class="fieldcontain">
					<span id="dob-label" class="property-label"><g:message code="account.dob.label" default="Dob" /></span>
					
						<span class="property-value" aria-labelledby="dob-label"><g:formatDate date="${accountInstance?.dob}" /></span>
